...
const ru = {
  ...
  "courses": {
    ...
    "assignedCoursesSubtitle": "Изучайте назначенные вам курсы и развивайте свои навыки программирования",
    "backToHome": "Назад к главной",
    "backToCourses": "Назад к курсам",
    "backToJournal": "Назад к журналу",
    "studyBasics": "Изучите основы программирования и алгоритмизации",
    "courseProgress": "Прогресс курса",
    "courseTitle": "ПМ02 - Составление алгоритма и создание блок-схемы на основе спецификации программного обеспечения",
    "courseDescription": "Составление алгоритма и создание блок-схемы на основе спецификации программного обеспечения",
    "coursePM01": "ПМ01 - Администрирование баз данных",
    "coursePM01Full": "Администрирование баз данных",
    "courseOOD14": "ООД14 - Графика и проектирование",
    "courseOOD14Full": "Графика и проектирование",
    "lesson": "Урок",
    ...
    "lessons": {
      "lesson1Title": "Введение в языки программирования...",
      "lesson1TitleFull": "Введение в языки программирования. Классификация языков программирования. Язык программирования Python. Выбор среды разработки",
      "lesson1Description": "Изучение основ программирования, классификации языков и знакомство с Python",
      "lesson2Title": "Переменные и типы данных",
      "lesson2Description": "Как хранить и обрабатывать информацию",
      ...
      "task": "Задание",
      "of": "из",
      "firstProgram": "Первая программа",
      "firstProgramDescription": "Напишите программу, которая выводит 'Привет, мир!'",
      "run": "Запустить",
      "back": "Назад",
      "next": "Далее",
      "navigation": "Навигация",
      "lessonProgress": "Прогресс урока",
      "testingByTopic": "Тестирование по теме урока",
      "testingDescription": "Проверьте свои знания с помощью интерактивного тестирования. Ответьте на вопросы по изученному материалу. Тест состоит из {count} вопросов с вариантами ответов. Время на выполнение: 20 минут.",
      "startTesting": "Начать тестирование",
      "testingTime": "Время тестирования",
      "goToQuestion": "Переход к вопросу:",
  ...
  "admin": {
    "journal": {
      ...
      "operations": "Операции",
      "teacherMenu": "Меню преподавателя",
      "topicName": "Название темы",
      "dates": "Даты проведения",
      "testGrade": "Оценка тестирования",
      "taskGrade": "Оценка решения задач",
      "averageGrade": "Средний балл",
      "lessonNames": {
        "lesson1": "Введение в языки программирования. Классификация языков программирования. Язык программирования Python. Выбор среды разработки.",
        "lesson2": "Переменные и типы данных"
      }
    },
    "settings": {
      "title": "Настройки",
...
const kk = {
  ...
  "courses": {
    ...
    "assignedCoursesSubtitle": "Сізге тағайындалған курстарды оқып, бағдарламалау дағдыларыңызды дамытыңыз",
    "backToHome": "Басты бетке оралу",
    "backToCourses": "Курстарға оралу",
    "backToJournal": "Журналға оралу",
    "studyBasics": "Бағдарламалау мен алгоритмдеудің негіздерін үйреніңіз",
    "courseProgress": "Курс прогрессі",
    "courseTitle": "ПМ02 - Бағдарламалық қамтамасыздандыру спецификациясы негізінде алгоритм құру және блок-схема жасау",
    "courseDescription": "Бағдарламалық қамтамасыздандыру спецификациясы негізінде алгоритм құру және блок-схема жасау",
    "coursePM01": "ПМ01 - Деректер қорын басқару",
    "coursePM01Full": "Деректер қорын басқару",
    "courseOOD14": "ООД14 - Графика және жобалау",
    "courseOOD14Full": "Графика және жобалау",
    "lesson": "Сабақ",
    "testing": "Тестілеу",
    "problemSolving": "Есептерді шешу",
    "locked": "Құлыпталған",
    "repeat": "Қайталау",
    "startLesson": "Сабақты бастау",
    "lessons": {
      "lesson1Title": "Бағдарламалау тілдеріне кіріспе...",
      "lesson1TitleFull": "Бағдарламалау тілдеріне кіріспе. Бағдарламалау тілдерінің классификациясы. Python бағдарламалау тілі. Әзірлеу ортасын таңдау",
      "lesson1Description": "Бағдарламалаудың негіздерін, тілдердің классификациясын және Python-мен танысу",
      "lesson2Title": "Айнымалылар және деректер типтері",
      "lesson2Description": "Ақпаратты қалай сақтау және өңдеу",
      ...
      "task": "Тапсырма",
      "of": "ден",
      "firstProgram": "Бірінші бағдарлама",
      "firstProgramDescription": "'Сәлем, әлем!' деп шығаратын бағдарлама жазыңыз",
      "run": "Іске қосу",
      "back": "Артқа",
      "next": "Келесі",
      "navigation": "Навигация",
      "lessonProgress": "Сабақ прогрессі",
      "testingByTopic": "Сабақ тақырыбы бойынша тестілеу",
      "testingDescription": "Интерактивті тестілеу арқылы біліміңізді тексеріңіз. Оқылған материал бойынша сұрақтарға жауап беріңіз. Тест жауап нұсқалары бар {count} сұрақтан тұрады. Орындау уақыты: 20 минут.",
      "startTesting": "Тестілеуді бастау",
      "testingTime": "Тестілеу уақыты",
  ...
  "admin": {
    "journal": {
      ...
      "completed": "аяқталды",
      "journalTitle": "ЖУРНАЛ",
      "subjectCode": "Пән коды",
      "operations": "Әрекеттер",
      "teacherMenu": "Мұғалім менюсі",
      "topicName": "Тақырып атауы",
      "dates": "Өткізу күндері",
      "testGrade": "Тестілеу бағасы",
      "taskGrade": "Есептерді шешу бағасы",
      "averageGrade": "Орташа балл",
      "lessonNames": {
        "lesson1": "Бағдарламалау тілдеріне кіріспе. Бағдарламалау тілдерінің классификациясы. Python бағдарламалау тілі. Әзірлеу ортасын таңдау.",
        "lesson2": "Айнымалылар және деректер типтері"
      }
    },
    "settings": {
      "title": "Баптаулар",
...
const en = {
  ...
  "courses": {
    ...
    "assignedCoursesSubtitle": "Study your assigned courses and develop your programming skills",
    "backToHome": "Back to Home",
    "subtitle": "Continue learning and develop your programming skills",
    "backToCourses": "Back to Courses",
    "backToJournal": "Back to Journal",
    "studyBasics": "Learn the basics of programming and algorithmization",
    "courseProgress": "Course Progress",
    "courseTitle": "PM02 - Algorithm Development and Flowchart Creation Based on Software Specification",
    "courseDescription": "Algorithm Development and Flowchart Creation Based on Software Specification",
    "coursePM01": "PM01 - Database Administration",
    "coursePM01Full": "Database Administration",
    "courseOOD14": "OOD14 - Graphics and Design",
    "courseOOD14Full": "Graphics and Design",
    "lesson": "Lesson",
    "testing": "Testing",
    ...
    "lessons": {
      "lesson1Title": "Introduction to Programming Languages...",
      "lesson1TitleFull": "Introduction to Programming Languages. Classification of Programming Languages. Python Programming Language. Choosing a Development Environment",
      "lesson1Description": "Learning programming basics, language classification, and introduction to Python",
      "lesson2Title": "Variables and Data Types",
      "lesson2Description": "How to store and process information",
      ...
      "firstProgramDescription": "Write a program that outputs 'Hello, world!'",
      "run": "Run",
      "back": "Back",
      "next": "Next",
      "navigation": "Navigation",
      "lessonProgress": "Lesson Progress",
      "testingByTopic": "Testing on Lesson Topic",
      "testingDescription": "Test your knowledge with interactive testing. Answer questions on the studied material. The test consists of {count} questions with answer options. Time to complete: 20 minutes.",
  ...
  "admin": {
    "journal": {
      ...
      "lessonNames": {
        "lesson1": "Introduction to Programming Languages. Programming Languages Classification. Python Programming Language. Development Environment Selection.",
